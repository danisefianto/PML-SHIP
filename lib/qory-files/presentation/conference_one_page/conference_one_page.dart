...
import 'package:pml_ship/presentation/conference_two_page/conference_two_page.dart';
...
class ConferenceOnePage extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Center(
            // Menengahkan teks "Opsi Pembayaran"
            child: Text(
              "Opsi Pembayaran",
              style: TextStyle(
                fontSize: 16,
  ...
  Widget _buildConfirmationVia(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          CustomImageView(
            imagePath: ImageConstant.imgCloseIndigo2000132x42,
            height: 32.v,
            marginBottom: 10,
          ),
        ],
        ...
        child: CustomElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ConferenceTwoPage(),
              ),
            );
          },
          onTap: () {},
