...
class HalamanNavigasiTigaScreen extends StatelessWidget {
  HalamanNavigasiTigaScreen({Key? key}) : super(key: key);
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => MetodePembayaranEmpatPage()),
                  );
                },
                child: Container(
                  width: 275,
                  ...
                  child: Center(
                    child: Text(
                      'Pembayaran Fase III Segera Dilakukan',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
