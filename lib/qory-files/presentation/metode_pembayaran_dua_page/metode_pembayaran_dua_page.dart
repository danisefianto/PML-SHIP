...
class MetodePembayaranDuaPage extends StatelessWidget {
  const MetodePembayaranDuaPage({Key? key}) : super(key: key);
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: InkWell(
                          onTap: () {
                            // Tidak ada navigasi untuk Pembayaran 2
                          },
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            mainAxisAlignment: MainAxisAlignment.center,
                ...
                child: CustomElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MetodePembayaranTigaPage(),
                      ),
                    );
                  },
                  onTap: () {},
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 9),
          Text(
            "Pembayaran langsung di awal dan di akhir",
            style: CustomTextStyles.bodySmallPoppins,
          ),
          SizedBox(height: 9),
          Text(
